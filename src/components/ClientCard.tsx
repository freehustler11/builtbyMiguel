      ...
      <div className="pt-4 border-t border-slate-100 dark:border-slate-800 space-y-3">
        ...
        <div className="grid grid-cols-3 gap-2 pt-1">
          <Link
            ...
            className="inline-flex items-center justify-center gap-1.5 py-2 px-2.5 rounded-xl text-xs font-bold text-slate-800 dark:text-slate-200 bg-slate-100 dark:bg-slate-800 hover:bg-blue-500 hover:text-white dark:hover:bg-blue-600 transition shadow-2xs group/ws"
            title="Open Client CRM Workspace"
          >
            <Briefcase className="w-3.5 h-3.5 text-blue-500 group-hover/ws:text-white transition-colors" />
            <span>Workspace</span>
          </Link>
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-1 py-2 px-2 rounded-xl text-xs font-bold text-white bg-rose-600 hover:bg-rose-500 transition shadow-2xs"
          >
          ...
          <Link
            to="/admin/reports"
            search={{ clientId: client.id }}
            className="inline-flex items-center justify-center gap-1 py-2 px-2 rounded-xl text-xs font-semibold text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 transition"
          >
