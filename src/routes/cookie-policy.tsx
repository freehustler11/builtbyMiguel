  ...
  return (
    <div className="w-full bg-[#FAF8F5] dark:bg-[#0B0F17] transition-colors duration-200">
      <div className="max-w-4xl mx-auto px-6 sm:px-8 py-12 sm:py-16 space-y-10 text-slate-600 dark:text-slate-300 leading-relaxed text-sm sm:text-base">
        ...
        <div className="p-5 rounded-3xl border border-amber-200/80 dark:border-amber-900/60 bg-amber-50 dark:bg-amber-950/40 text-amber-900 dark:text-amber-300 text-sm flex items-start gap-3 shadow-xs">
          <Cookie className="w-5 h-5 shrink-0 mt-0.5 text-amber-600 dark:text-amber-400" />
          <div>
        ...
        <div className="space-y-8">
          <section className="space-y-3">
            <h2 className="text-xl font-display font-bold text-slate-900 dark:text-white">1. What Are Cookies?</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-display font-bold text-slate-900 dark:text-white">2. Cookies We Use</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-display font-bold text-slate-900 dark:text-white">3. Managing Cookie Preferences</h2>
            <p>
          ...
          <section className="space-y-3 pt-6 border-t border-slate-200 dark:border-slate-800">
            <h2 className="text-xl font-display font-bold text-slate-900 dark:text-white">4. Contact Us</h2>
            <p>
              If you have questions regarding our cookie practices, email <a href="mailto:privacy@builtbymiguel.net" className="text-amber-600 dark:text-amber-400 hover:underline font-mono">privacy@builtbymiguel.net</a>.
            </p>
          </section>
        </div>
      </div>
