...
function PrivacyPolicyPage() {
  ...
  return (
    <div className="w-full bg-[#FAF8F5] dark:bg-[#0B0F17] transition-colors duration-200">
      <div className="max-w-4xl mx-auto px-6 sm:px-8 py-12 sm:py-16 space-y-10 text-slate-600 dark:text-slate-300 leading-relaxed text-sm sm:text-base">
        {/* Header */}
        <div className="space-y-3 pb-6 border-b border-slate-200 dark:border-slate-800">
          <Link
            to="/"
            className="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-500 hover:text-amber-600 dark:hover:text-amber-400 transition-colors"
          >
        ...
        <div className="p-5 rounded-3xl border border-emerald-200 dark:border-emerald-800/60 bg-emerald-50 dark:bg-emerald-950/40 text-emerald-800 dark:text-emerald-300 text-sm flex items-start gap-3 shadow-xs">
        ...
        <div className="space-y-8">
          <section className="space-y-3">
            <h2 className="text-xl font-display font-bold text-slate-900 dark:text-white">1. Information We Collect</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-display font-bold text-slate-900 dark:text-white">2. How We Use Your Information</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-display font-bold text-slate-900 dark:text-white">3. Data Security & Storage</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-display font-bold text-slate-900 dark:text-white">4. Third-Party Service Providers</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-display font-bold text-slate-900 dark:text-white">5. Your Data Rights</h2>
            <p>
              You have the right to request access to, correction of, or complete deletion of your personal data from our systems at any time. Simply contact us at <a href="mailto:privacy@builtbymiguel.net" className="text-amber-600 dark:text-amber-400 hover:underline font-mono">privacy@builtbymiguel.net</a>.
            </p>
          </section>

          <section className="space-y-3 pt-6 border-t border-slate-200 dark:border-slate-800">
            <h2 className="text-xl font-display font-bold text-slate-900 dark:text-white">6. Contact Information</h2>
            <p>
              If you have questions regarding this Privacy Policy, contact:
            </p>
            <div className="p-5 rounded-3xl bg-white dark:bg-[#111827] border border-slate-200/80 dark:border-slate-800 font-mono text-xs text-slate-600 dark:text-slate-400 space-y-1.5 shadow-sm dark:shadow-none">
              <div className="font-bold text-slate-900 dark:text-white font-display text-sm">built by Miguel</div>
              <div>Attn: Privacy & Data Protection</div>
              <div>Email: <a href="mailto:privacy@builtbymiguel.net" className="text-amber-600 dark:text-amber-400 hover:underline">privacy@builtbymiguel.net</a></div>
