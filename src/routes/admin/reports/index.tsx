              ...
              return (
                ...
                >
                  <div className="space-y-4">
                    ...
                    {/* Report Month Badge & Created Date */}
                  ...
                  <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-end gap-2">
                    <Link
                      to="/admin/reports/$id"
                      params={{ id: report.id }}
                      className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold text-white bg-slate-900 dark:bg-rose-600 hover:bg-black dark:hover:bg-rose-500 shadow-xs transition-all cursor-pointer"
                    >
