      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-8 py-12 sm:py-16 space-y-10 text-slate-600 dark:text-slate-300 leading-relaxed text-sm sm:text-base">
        ...
        <div className="space-y-8">
          <section className="space-y-3">
            <h2 className="text-xl font-display font-bold text-slate-900 dark:text-white">1. Agreement to Terms</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-display font-bold text-slate-900 dark:text-white">2. Scope of Services</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-display font-bold text-slate-900 dark:text-white">3. Intellectual Property & Code Ownership</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-display font-bold text-slate-900 dark:text-white">4. Monthly Retainers & Cancellation</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-display font-bold text-slate-900 dark:text-white">5. Limitation of Liability</h2>
            <p>
          ...
          <section className="space-y-3 pt-6 border-t border-slate-200 dark:border-slate-800">
            <h2 className="text-xl font-display font-bold text-slate-900 dark:text-white">6. Governing Law</h2>
            <p>
              These terms are governed by and construed in accordance with the laws of the United States. For any inquiries regarding legal agreements, contact <a href="mailto:legal@builtbymiguel.net" className="text-amber-600 dark:text-amber-400 hover:underline font-mono">legal@builtbymiguel.net</a>.
            </p>
          </section>
        </div>
      </div>
